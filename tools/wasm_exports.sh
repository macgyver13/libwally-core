...
,'_wally_musig_aggnonce_free' \
,'_wally_musig_aggnonce_parse' \
,'_wally_musig_aggnonce_serialize' \
,'_wally_musig_keyagg_cache_free' \
,'_wally_musig_keyagg_cache_parse' \
,'_wally_musig_keyagg_cache_serialize' \
,'_wally_musig_nonce_agg' \
,'_wally_musig_nonce_gen' \
,'_wally_musig_nonce_gen_counter' \
,'_wally_musig_nonce_process' \
,'_wally_musig_partial_sig_agg' \
,'_wally_musig_partial_sig_free' \
,'_wally_musig_partial_sig_parse' \
,'_wally_musig_partial_sig_serialize' \
,'_wally_musig_partial_sig_verify' \
,'_wally_musig_partial_sign' \
,'_wally_musig_pubkey_agg' \
,'_wally_musig_pubkey_ec_tweak_add' \
,'_wally_musig_pubkey_get' \
,'_wally_musig_pubkey_to_xpub' \
,'_wally_musig_pubkey_xonly_tweak_add' \
,'_wally_musig_pubkeys_agg_then_derive' \
,'_wally_musig_pubkeys_derive_then_agg' \
,'_wally_musig_pubnonce_free' \
,'_wally_musig_pubnonce_parse' \
,'_wally_musig_pubnonce_serialize' \
,'_wally_musig_secnonce_free' \
,'_wally_musig_session_free' \
,'_wally_musig_session_parse' \
,'_wally_musig_session_serialize' \
...
,'_wally_psbt_find_global_sp_dleq_proof' \
,'_wally_psbt_find_global_sp_ecdh_share' \
...
,'_wally_psbt_get_input_sp_dleq_proof' \
,'_wally_psbt_get_input_sp_dleq_proof_len' \
,'_wally_psbt_get_input_sp_dleq_proofs_size' \
...
,'_wally_psbt_get_output_sp_v0_info' \
,'_wally_psbt_get_output_sp_v0_info_len' \
,'_wally_psbt_get_output_sp_v0_label' \
,'_wally_psbt_get_output_sp_v0_label_len' \
...
,'_wally_psbt_get_sp_musig_status' \
...
,'_wally_psbt_input_add_musig2_partial_sig' \
,'_wally_psbt_input_add_musig2_participant_pubkeys' \
,'_wally_psbt_input_add_musig2_pubnonce' \
,'_wally_psbt_input_add_signature' \
,'_wally_psbt_input_add_taproot_leaf_script' \
,'_wally_psbt_input_add_taproot_leaf_signature' \
...
,'_wally_psbt_input_find_musig2_partial_sig' \
,'_wally_psbt_input_find_musig2_pubkey' \
,'_wally_psbt_input_find_musig2_pubnonce' \
,'_wally_psbt_input_find_signature' \
,'_wally_psbt_input_find_sp_partial_dleq_proof' \
,'_wally_psbt_input_find_sp_partial_ecdh_share' \
,'_wally_psbt_input_find_unknown' \
,'_wally_psbt_input_get_musig2_partial_sig_size' \
,'_wally_psbt_input_get_musig2_pubnonce_size' \
,'_wally_psbt_input_get_taproot_keypaths_size' \
,'_wally_psbt_input_get_taproot_leaf_script_size' \
,'_wally_psbt_input_get_taproot_leaf_signature_size' \
,'_wally_psbt_input_is_finalized' \
,'_wally_psbt_input_keypath_add' \
,'_wally_psbt_input_populate_taproot_from_descriptor' \
,'_wally_psbt_input_set_final_scriptsig' \
,'_wally_psbt_input_set_final_witness' \
,'_wally_psbt_input_set_keypaths' \
,'_wally_psbt_input_set_musig2_pubkeys' \
...
,'_wally_psbt_input_set_sp_partial_dleq_proof' \
,'_wally_psbt_input_set_sp_partial_ecdh_share' \
...
,'_wally_psbt_output_populate_taproot_from_descriptor' \
...
,'_wally_psbt_populate_musig2_from_descriptor' \
...
,'_wally_psbt_set_output_sp_v0_info' \
,'_wally_psbt_set_output_sp_v0_label' \
...
,'_wally_psbt_sp_musig_contribute' \
,'_wally_psbt_sp_musig_resolve_shares' \
