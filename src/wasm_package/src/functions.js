...
export const aes_cbc_get_maximum_length = wrap('wally_aes_cbc_get_maximum_length', [T.Bytes, T.Bytes, T.Bytes, T.Int32, T.DestPtr(T.Int32)]);
export const aes_cbc_with_ecdh_key_get_maximum_length = wrap('wally_aes_cbc_with_ecdh_key_get_maximum_length', [T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Int32, T.DestPtr(T.Int32)]);
...
export const base64_n_get_maximum_length = wrap('wally_base64_n_get_maximum_length', [T.String, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const bip32_path_from_str_len = wrap('bip32_path_from_str_len', [T.String, T.Int32, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
export const bip32_path_from_str_n_len = wrap('bip32_path_from_str_n_len', [T.String, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const descriptor_get_key = wrap('wally_descriptor_get_key', [T.OpaqueRef, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_get_key_child_path_str_len = wrap('wally_descriptor_get_key_child_path_str_len', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const descriptor_get_key_features = wrap('wally_descriptor_get_key_features', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const descriptor_get_key_origin_fingerprint = wrap('wally_descriptor_get_key_origin_fingerprint', [T.OpaqueRef, T.Int32, T.DestPtrSized(T.Bytes, C.BIP32_KEY_FINGERPRINT_LEN)]);
export const descriptor_get_key_origin_path_str_len = wrap('wally_descriptor_get_key_origin_path_str_len', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const descriptor_get_musig_num_participants = wrap('wally_descriptor_get_musig_num_participants', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const descriptor_get_musig_participant_key = wrap('wally_descriptor_get_musig_participant_key', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_get_musig_participant_key_features = wrap('wally_descriptor_get_musig_participant_key_features', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
export const descriptor_get_musig_participant_key_origin_fingerprint = wrap('wally_descriptor_get_musig_participant_key_origin_fingerprint', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtrSized(T.Bytes, C.BIP32_KEY_FINGERPRINT_LEN)]);
export const descriptor_get_musig_participant_key_origin_path_str_len = wrap('wally_descriptor_get_musig_participant_key_origin_path_str_len', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const descriptor_get_taproot_leaf_script_len = wrap('wally_descriptor_get_taproot_leaf_script_len', [T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
export const descriptor_get_taproot_merkle_root = wrap('wally_descriptor_get_taproot_merkle_root', [T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.DestPtrSized(T.Bytes, C.SHA256_LEN)]);
export const descriptor_get_taproot_num_leaves = wrap('wally_descriptor_get_taproot_num_leaves', [T.OpaqueRef, T.DestPtr(T.Int32)]);
...
export const elip150_private_key_to_ec_private_key = wrap('wally_elip150_private_key_to_ec_private_key', [T.Bytes, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_PRIVATE_KEY_LEN)]);
export const elip150_private_key_to_ec_public_key = wrap('wally_elip150_private_key_to_ec_public_key', [T.Bytes, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_PUBLIC_KEY_LEN)]);
export const elip150_public_key_to_ec_public_key = wrap('wally_elip150_public_key_to_ec_public_key', [T.Bytes, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_PUBLIC_KEY_LEN)]);
...
export const musig_aggnonce_free = wrap('wally_musig_aggnonce_free', [T.OpaqueRef]);
export const musig_aggnonce_parse = wrap('wally_musig_aggnonce_parse', [T.Bytes, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_aggnonce_serialize = wrap('wally_musig_aggnonce_serialize', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.WALLY_MUSIG_AGGNONCE_LEN)]);
export const musig_keyagg_cache_free = wrap('wally_musig_keyagg_cache_free', [T.OpaqueRef]);
export const musig_keyagg_cache_parse = wrap('wally_musig_keyagg_cache_parse', [T.Bytes, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_keyagg_cache_serialize = wrap('wally_musig_keyagg_cache_serialize', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.WALLY_MUSIG_KEYAGG_CACHE_LEN)]);
export const musig_nonce_agg = wrap('wally_musig_nonce_agg', [T.Bytes, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_nonce_gen = wrap('wally_musig_nonce_gen', [T.Bytes, T.Bytes, T.Bytes, T.OpaqueRef, T.Bytes, T.Bytes, T.DestPtrPtr(T.OpaqueRef), T.DestPtrPtr(T.OpaqueRef)]);
export const musig_nonce_gen_counter = wrap('wally_musig_nonce_gen_counter', [T.Int64, T.Bytes, T.Bytes, T.OpaqueRef, T.Bytes, T.Bytes, T.DestPtrPtr(T.OpaqueRef), T.DestPtrPtr(T.OpaqueRef)]);
export const musig_nonce_process = wrap('wally_musig_nonce_process', [T.OpaqueRef, T.Bytes, T.OpaqueRef, T.Bytes, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_partial_sig_agg = wrap('wally_musig_partial_sig_agg', [T.Bytes, T.Int32, T.OpaqueRef, T.DestPtrSized(T.Bytes, C.EC_SIGNATURE_LEN)]);
export const musig_partial_sig_free = wrap('wally_musig_partial_sig_free', [T.OpaqueRef]);
export const musig_partial_sig_parse = wrap('wally_musig_partial_sig_parse', [T.Bytes, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_partial_sig_serialize = wrap('wally_musig_partial_sig_serialize', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.WALLY_MUSIG_PARTIAL_SIG_LEN)]);
export const musig_partial_sig_verify = wrap('wally_musig_partial_sig_verify', [T.OpaqueRef, T.OpaqueRef, T.Bytes, T.OpaqueRef, T.OpaqueRef]);
export const musig_partial_sign = wrap('wally_musig_partial_sign', [T.OpaqueRef, T.Bytes, T.OpaqueRef, T.OpaqueRef, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_pubkey_agg = wrap('wally_musig_pubkey_agg', [T.Bytes, T.DestPtrSized(T.Bytes, C.EC_XONLY_PUBLIC_KEY_LEN), T.DestPtrPtr(T.OpaqueRef)]);
export const musig_pubkey_ec_tweak_add = wrap('wally_musig_pubkey_ec_tweak_add', [T.OpaqueRef, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_PUBLIC_KEY_LEN)]);
export const musig_pubkey_get = wrap('wally_musig_pubkey_get', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.EC_PUBLIC_KEY_LEN)]);
export const musig_pubkey_to_xpub = wrap('wally_musig_pubkey_to_xpub', [T.Bytes, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_pubkey_xonly_tweak_add = wrap('wally_musig_pubkey_xonly_tweak_add', [T.OpaqueRef, T.Bytes, T.DestPtrSized(T.Bytes, C.EC_PUBLIC_KEY_LEN)]);
export const musig_pubkeys_agg_then_derive = wrap('wally_musig_pubkeys_agg_then_derive', [T.Bytes, T.Int32, T.Int32, T.DestPtrSized(T.Bytes, C.EC_PUBLIC_KEY_LEN), T.DestPtrPtr(T.OpaqueRef)]);
export const musig_pubkeys_derive_then_agg = wrap('wally_musig_pubkeys_derive_then_agg', [T.Bytes, T.Int32, T.DestPtrSized(T.Bytes, C.EC_XONLY_PUBLIC_KEY_LEN), T.DestPtrPtr(T.OpaqueRef)]);
...
export const musig_pubnonce_serialize = wrap('wally_musig_pubnonce_serialize', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.WALLY_MUSIG_PUBNONCE_LEN)]);
export const musig_secnonce_free = wrap('wally_musig_secnonce_free', [T.OpaqueRef]);
export const musig_session_free = wrap('wally_musig_session_free', [T.OpaqueRef]);
export const musig_session_parse = wrap('wally_musig_session_parse', [T.Bytes, T.DestPtrPtr(T.OpaqueRef)]);
export const musig_session_serialize = wrap('wally_musig_session_serialize', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.WALLY_MUSIG_SESSION_LEN)]);
...
export const psbt_add_input_sp_spend_keypath = wrap('wally_psbt_add_input_sp_spend_keypath', [T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Uint32Array]);
...
export const psbt_clear_input_sp_tweak = wrap('wally_psbt_clear_input_sp_tweak', [T.OpaqueRef, T.Int32]);
...
export const psbt_clear_output_sp_v0_info = wrap('wally_psbt_clear_output_sp_v0_info', [T.OpaqueRef, T.Int32]);
export const psbt_clear_output_sp_v0_label = wrap('wally_psbt_clear_output_sp_v0_label', [T.OpaqueRef, T.Int32]);
...
export const psbt_find_global_sp_dleq_proof = wrap('wally_psbt_find_global_sp_dleq_proof', [T.OpaqueRef, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_find_global_sp_ecdh_share = wrap('wally_psbt_find_global_sp_ecdh_share', [T.OpaqueRef, T.Bytes, T.DestPtr(T.Int32)]);
...
export const psbt_find_input_sp_dleq_proof = wrap('wally_psbt_find_input_sp_dleq_proof', [T.OpaqueRef, T.Int32, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_find_input_sp_ecdh_share = wrap('wally_psbt_find_input_sp_ecdh_share', [T.OpaqueRef, T.Int32, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_find_input_sp_spend_keypath = wrap('wally_psbt_find_input_sp_spend_keypath', [T.OpaqueRef, T.Int32, T.Bytes, T.DestPtr(T.Int32)]);
...
export const psbt_get_global_genesis_blockhash = wrap('wally_psbt_get_global_genesis_blockhash', [T.OpaqueRef, T.DestPtrVarLen(T.Bytes, C.SHA256_LEN, true)]);
...
export const psbt_get_input_sp_dleq_proof_len = wrap('wally_psbt_get_input_sp_dleq_proof_len', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
export const psbt_get_input_sp_dleq_proofs_size = wrap('wally_psbt_get_input_sp_dleq_proofs_size', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
...
export const psbt_get_output_sp_v0_info_len = wrap('wally_psbt_get_output_sp_v0_info_len', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const psbt_get_output_sp_v0_label_len = wrap('wally_psbt_get_output_sp_v0_label_len', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
export const psbt_get_output_taproot_internal_key_len = wrap('wally_psbt_get_output_taproot_internal_key_len', [T.OpaqueRef, T.Int32, T.DestPtr(T.Int32)]);
...
export const psbt_get_sp_musig_session_digest = wrap('wally_psbt_get_sp_musig_session_digest', [T.OpaqueRef, T.DestPtrSized(T.Bytes, C.SHA256_LEN)]);
export const psbt_get_sp_musig_status = wrap('wally_psbt_get_sp_musig_status', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Int32, T.DestPtr(T.Int32)]);
...
export const psbt_input_add_musig2_partial_sig = wrap('wally_psbt_input_add_musig2_partial_sig', [T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes, T.Bytes]);
export const psbt_input_add_musig2_participant_pubkeys = wrap('wally_psbt_input_add_musig2_participant_pubkeys', [T.OpaqueRef, T.Bytes, T.Bytes]);
export const psbt_input_add_musig2_pubnonce = wrap('wally_psbt_input_add_musig2_pubnonce', [T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes, T.Bytes]);
export const psbt_input_add_signature = wrap('wally_psbt_input_add_signature', [T.OpaqueRef, T.Bytes, T.Bytes]);
export const psbt_input_add_taproot_leaf_script = wrap('wally_psbt_input_add_taproot_leaf_script', [T.OpaqueRef, T.Bytes, T.Bytes]);
export const psbt_input_add_taproot_leaf_signature = wrap('wally_psbt_input_add_taproot_leaf_signature', [T.OpaqueRef, T.Bytes, T.Bytes]);
...
export const psbt_input_find_musig2_partial_sig = wrap('wally_psbt_input_find_musig2_partial_sig', [T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_input_find_musig2_pubkey = wrap('wally_psbt_input_find_musig2_pubkey', [T.OpaqueRef, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_input_find_musig2_pubnonce = wrap('wally_psbt_input_find_musig2_pubnonce', [T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_input_find_signature = wrap('wally_psbt_input_find_signature', [T.OpaqueRef, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_input_find_sp_partial_dleq_proof = wrap('wally_psbt_input_find_sp_partial_dleq_proof', [T.OpaqueRef, T.Bytes, T.Bytes, T.DestPtr(T.Int32)]);
export const psbt_input_find_sp_partial_ecdh_share = wrap('wally_psbt_input_find_sp_partial_ecdh_share', [T.OpaqueRef, T.Bytes, T.Bytes, T.DestPtr(T.Int32)]);
...
export const psbt_input_get_musig2_partial_sig_size = wrap('wally_psbt_input_get_musig2_partial_sig_size', [T.OpaqueRef, T.DestPtr(T.Int32)]);
export const psbt_input_get_musig2_pubnonce_size = wrap('wally_psbt_input_get_musig2_pubnonce_size', [T.OpaqueRef, T.DestPtr(T.Int32)]);
...
export const psbt_input_get_taproot_keypaths_size = wrap('wally_psbt_input_get_taproot_keypaths_size', [T.OpaqueRef, T.DestPtr(T.Int32)]);
export const psbt_input_get_taproot_leaf_script_size = wrap('wally_psbt_input_get_taproot_leaf_script_size', [T.OpaqueRef, T.DestPtr(T.Int32)]);
export const psbt_input_get_taproot_leaf_signature_size = wrap('wally_psbt_input_get_taproot_leaf_signature_size', [T.OpaqueRef, T.DestPtr(T.Int32)]);
...
export const psbt_input_populate_taproot_from_descriptor = wrap('wally_psbt_input_populate_taproot_from_descriptor', [T.OpaqueRef, T.Int32, T.OpaqueRef, T.Int32, T.Int32, T.Int32]);
...
export const psbt_input_set_musig2_pubkeys = wrap('wally_psbt_input_set_musig2_pubkeys', [T.OpaqueRef, T.OpaqueRef]);
...
export const psbt_input_set_sp_partial_dleq_proof = wrap('wally_psbt_input_set_sp_partial_dleq_proof', [T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes]);
export const psbt_input_set_sp_partial_ecdh_share = wrap('wally_psbt_input_set_sp_partial_ecdh_share', [T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes]);
export const psbt_input_set_taproot_internal_key = wrap('wally_psbt_input_set_taproot_internal_key', [T.OpaqueRef, T.Bytes]);
...
export const psbt_input_sp_spend_keypath_add = wrap('wally_psbt_input_sp_spend_keypath_add', [T.OpaqueRef, T.Bytes, T.Bytes, T.Uint32Array]);
...
export const psbt_musig2_add_nonce = wrap('wally_psbt_musig2_add_nonce', [T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.OpaqueRef, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const psbt_musig2_agg_then_derive_add_nonce = wrap('wally_psbt_musig2_agg_then_derive_add_nonce', [T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Uint32Array, T.Bytes, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const psbt_musig2_agg_then_derive_finalize_input = wrap('wally_psbt_musig2_agg_then_derive_finalize_input', [T.OpaqueRef, T.Int32, T.Bytes, T.Uint32Array, T.Int32]);
export const psbt_musig2_agg_then_derive_sign = wrap('wally_psbt_musig2_agg_then_derive_sign', [T.OpaqueRef, T.Int32, T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes, T.Uint32Array, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const psbt_musig2_finalize_input = wrap('wally_psbt_musig2_finalize_input', [T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.OpaqueRef, T.Int32]);
export const psbt_musig2_sign = wrap('wally_psbt_musig2_sign', [T.OpaqueRef, T.Int32, T.OpaqueRef, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.OpaqueRef, T.Int32, T.DestPtrPtr(T.OpaqueRef)]);
export const psbt_output_add_musig2_participant_pubkeys = wrap('wally_psbt_output_add_musig2_participant_pubkeys', [T.OpaqueRef, T.Bytes, T.Bytes]);
...
export const psbt_output_find_musig2_pubkey = wrap('wally_psbt_output_find_musig2_pubkey', [T.OpaqueRef, T.Bytes, T.DestPtr(T.Int32)]);
...
export const psbt_output_populate_taproot_from_descriptor = wrap('wally_psbt_output_populate_taproot_from_descriptor', [T.OpaqueRef, T.Int32, T.OpaqueRef, T.Int32, T.Int32, T.Int32]);
...
export const psbt_output_set_musig2_pubkeys = wrap('wally_psbt_output_set_musig2_pubkeys', [T.OpaqueRef, T.OpaqueRef]);
...
export const psbt_output_set_taproot_internal_key = wrap('wally_psbt_output_set_taproot_internal_key', [T.OpaqueRef, T.Bytes]);
...
export const psbt_populate_musig2_from_descriptor = wrap('wally_psbt_populate_musig2_from_descriptor', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Int32]);
...
export const psbt_set_global_genesis_blockhash = wrap('wally_psbt_set_global_genesis_blockhash', [T.OpaqueRef, T.Bytes]);
...
export const psbt_set_input_sp_tweak = wrap('wally_psbt_set_input_sp_tweak', [T.OpaqueRef, T.Int32, T.Bytes]);
export const psbt_set_input_taproot_internal_key = wrap('wally_psbt_set_input_taproot_internal_key', [T.OpaqueRef, T.Int32, T.Bytes]);
...
export const psbt_set_output_sp_v0_info = wrap('wally_psbt_set_output_sp_v0_info', [T.OpaqueRef, T.Int32, T.Bytes]);
export const psbt_set_output_sp_v0_label = wrap('wally_psbt_set_output_sp_v0_label', [T.OpaqueRef, T.Int32, T.Bytes]);
export const psbt_set_output_taproot_internal_key = wrap('wally_psbt_set_output_taproot_internal_key', [T.OpaqueRef, T.Int32, T.Bytes]);
...
export const psbt_signing_cache_disable = wrap('wally_psbt_signing_cache_disable', [T.OpaqueRef]);
export const psbt_signing_cache_enable = wrap('wally_psbt_signing_cache_enable', [T.OpaqueRef, T.Int32]);
export const psbt_sp_contribute = wrap('wally_psbt_sp_contribute', [T.OpaqueRef, T.Uint32Array, T.Bytes, T.Bytes, T.Int32]);
export const psbt_sp_musig_contribute = wrap('wally_psbt_sp_musig_contribute', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Int32]);
export const psbt_sp_musig_resolve_shares = wrap('wally_psbt_sp_musig_resolve_shares', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Int32]);
export const psbt_sp_musig_round1 = wrap('wally_psbt_sp_musig_round1', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Uint32Array, T.Bytes, T.Bytes, T.Int32, T.DestPtrPtr(T.OpaqueRef), T.DestPtrSized(T.Bytes, C.SHA256_LEN), T.DestPtr(T.Int32)]);
export const psbt_sp_musig_round2 = wrap('wally_psbt_sp_musig_round2', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Uint32Array, T.Bytes, T.DestPtrPtr(T.OpaqueRef), T.Bytes, T.Int32]);
export const psbt_sp_resolve = wrap('wally_psbt_sp_resolve', [T.OpaqueRef, T.Bytes, T.Bytes, T.Int32]);
export const psbt_sp_resolve_shares = wrap('wally_psbt_sp_resolve_shares', [T.OpaqueRef, T.Int32]);
...
export const sp_address_from_bytes = wrap('wally_sp_address_from_bytes', [T.Bytes, T.String, T.Int32, T.DestPtrPtr(T.String)]);
...
export const tx_input_clone = wrap('wally_tx_input_clone_alloc', [T.OpaqueRef, T.DestPtrPtr(T.OpaqueRef)]);
export const tx_input_clone_noalloc = wrap('wally_tx_input_clone', [T.OpaqueRef, T.OpaqueRef]);
...
export const tx_input_get_witness_num_items = wrap('wally_tx_input_get_witness_num_items', [T.OpaqueRef, T.DestPtr(T.Int32)]);
...
export const aes_cbc = wrap('wally_aes_cbc', [T.Bytes, T.Bytes, T.Bytes, T.Int32, T.DestPtrVarLen(T.Bytes, aes_cbc_get_maximum_length, true)]);
export const aes_cbc_with_ecdh_key = wrap('wally_aes_cbc_with_ecdh_key', [T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Bytes, T.Int32, T.DestPtrVarLen(T.Bytes, aes_cbc_with_ecdh_key_get_maximum_length, true)]);
...
export const base64_n_to_bytes = wrap('wally_base64_n_to_bytes', [T.String, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, base64_n_get_maximum_length, true)]);
...
export const bip32_path_from_str = wrap('bip32_path_from_str', [T.String, T.Int32, T.Int32, T.Int32, T.DestPtrVarLen(T.Uint32Array, bip32_path_from_str_len, false)]);
export const bip32_path_from_str_n = wrap('bip32_path_from_str_n', [T.String, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtrVarLen(T.Uint32Array, bip32_path_from_str_n_len, false)]);
export const descriptor_get_key_child_path_str = wrap('wally_descriptor_get_key_child_path_str', [T.OpaqueRef, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_get_key_origin_path_str = wrap('wally_descriptor_get_key_origin_path_str', [T.OpaqueRef, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_get_musig_participant_key_origin_path_str = wrap('wally_descriptor_get_musig_participant_key_origin_path_str', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtrPtr(T.String)]);
export const descriptor_get_taproot_control_block = wrap('wally_descriptor_get_taproot_control_block', [T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, descriptor_get_taproot_control_block_len, false)]);
export const descriptor_get_taproot_leaf_script = wrap('wally_descriptor_get_taproot_leaf_script', [T.OpaqueRef, T.Int32, T.Int32, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, descriptor_get_taproot_leaf_script_len, false)]);
...
export const psbt_get_input_sp_dleq_proof = wrap('wally_psbt_get_input_sp_dleq_proof', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_input_sp_dleq_proof_len, false)]);
export const psbt_get_input_sp_ecdh_share = wrap('wally_psbt_get_input_sp_ecdh_share', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_input_sp_ecdh_share_len, false)]);
export const psbt_get_input_sp_spend_keypath = wrap('wally_psbt_get_input_sp_spend_keypath', [T.OpaqueRef, T.Int32, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_input_sp_spend_keypath_len, false)]);
export const psbt_get_input_sp_tweak = wrap('wally_psbt_get_input_sp_tweak', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_input_sp_tweak_len, false)]);
export const psbt_get_input_taproot_internal_key = wrap('wally_psbt_get_input_taproot_internal_key', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_input_taproot_internal_key_len, false)]);
...
export const psbt_get_output_sp_v0_info = wrap('wally_psbt_get_output_sp_v0_info', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_output_sp_v0_info_len, false)]);
export const psbt_get_output_sp_v0_label = wrap('wally_psbt_get_output_sp_v0_label', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_output_sp_v0_label_len, false)]);
export const psbt_get_output_taproot_internal_key = wrap('wally_psbt_get_output_taproot_internal_key', [T.OpaqueRef, T.Int32, T.DestPtrVarLen(T.Bytes, psbt_get_output_taproot_internal_key_len, false)]);
