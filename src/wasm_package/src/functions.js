...
export const psbt_input_set_sp_dleq_proof = wrap('wally_psbt_input_set_sp_dleq_proof', [T.OpaqueRef, T.Bytes, T.Bytes]);
...
export const psbt_set_global_sp_dleq_proof = wrap('wally_psbt_set_global_sp_dleq_proof', [T.OpaqueRef, T.Bytes, T.Bytes]);
export const psbt_set_global_sp_ecdh_share = wrap('wally_psbt_set_global_sp_ecdh_share', [T.OpaqueRef, T.Bytes, T.Bytes]);
