...
export const psbt_sp_musig_round1 = wrap('wally_psbt_sp_musig_round1', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Bytes, T.Bytes, T.Int32, T.DestPtrPtr(T.OpaqueRef), T.DestPtrSized(T.Bytes, C.SHA256_LEN), T.DestPtr(T.Int32)]);
export const psbt_sp_musig_round2 = wrap('wally_psbt_sp_musig_round2', [T.OpaqueRef, T.OpaqueRef, T.Int32, T.Bytes, T.DestPtrPtr(T.OpaqueRef), T.Bytes, T.Int32]);
