...
export const WALLY_BUILD_VER = 0x10506;
...
export const WALLY_DESCRIPTOR_TAPTREE_MAX_DEPTH = 128; /* BIP-341: maximum taptree depth */
...
export const WALLY_MS_ANY_BLINDING_KEY = 0x0E00; /** SLIP-77, ELIP-150 or ELIP-151 blinding key present */
...
export const WALLY_MS_IS_DESCRIPTOR = 0x0020; /** Contains only descriptor expressions (no miniscript) */
export const WALLY_MS_IS_ELEMENTS = 0x0100; /** Contains Elements expressions or was parsed as Elements */
...
export const WALLY_MS_IS_RAW = 0x0010; /** Contains at least one raw key */
export const WALLY_MS_IS_SLIP77 = 0x0200; /** A confidential ct() descriptor with SLIP-77 blinding */
export const WALLY_MS_IS_TAPROOT = 0x1000; /** Contains a tr() taproot expression */
export const WALLY_MS_IS_TAPSCRIPT = 0x2000; /** Contains a tr(key,{...}) tapscript tree expression */
export const WALLY_MS_IS_UNCOMPRESSED = 0x0008; /** Contains at least one uncompressed key */
export const WALLY_MS_IS_X_ONLY = 0x0040; /** Contains at least one x-only key */
export const WALLY_MUSIG2_CHAINCODE_LEN = 32;
export const WALLY_MUSIG_AGGNONCE_LEN = 66;
export const WALLY_MUSIG_KEYAGG_CACHE_LEN = 197;
export const WALLY_MUSIG_PARTIAL_SIG_LEN = 32;
export const WALLY_MUSIG_PUBNONCE_LEN = 66;
export const WALLY_MUSIG_SESSION_LEN = 133;
...
export const WALLY_PATCH_VER = 6;
...
export const WALLY_PSBT_SERIALIZE_SIGS_ONLY = 0x2;
...
export const WALLY_SP_OUTPOINT_LEN = 36;
export const WALLY_SP_SCAN_KEY_LEN = 65; /** BIP-392 ser256(b_scan) || serP(B_spend) */
export const WALLY_SP_SPEND_KEY_LEN = 64; /** BIP-392 ser256(b_scan) || ser256(b_spend) */
export const WALLY_SP_V0_INFO_LEN = 66; /** BIP-352 serP(B_scan) || serP(B_spend) */
