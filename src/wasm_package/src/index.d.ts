...
export function musig_aggnonce_free(nonce: Ref_wally_musig_aggnonce): void;
export function musig_aggnonce_parse(bytes: Buffer|Uint8Array|null): Ref_wally_musig_aggnonce;
export function musig_aggnonce_serialize(nonce: Ref_wally_musig_aggnonce): Buffer;
export function musig_keyagg_cache_free(cache: Ref_wally_musig_keyagg_cache): void;
export function musig_keyagg_cache_parse(bytes: Buffer|Uint8Array|null): Ref_wally_musig_keyagg_cache;
export function musig_keyagg_cache_serialize(cache: Ref_wally_musig_keyagg_cache): Buffer;
export function musig_nonce_agg(pubnonces: Buffer|Uint8Array|null, n_pubnonces: number): Ref_wally_musig_aggnonce;
export function musig_nonce_gen(session_secrand32: Buffer|Uint8Array|null, seckey: Buffer|Uint8Array|null, pub_key: Buffer|Uint8Array|null, keyagg_cache: Ref_wally_musig_keyagg_cache, msg32: Buffer|Uint8Array|null, extra_input32: Buffer|Uint8Array|null): [secnonce_out: Ref_wally_musig_secnonce, pubnonce_out: Ref_wally_musig_pubnonce];
export function musig_nonce_gen_counter(counter: bigint, seckey: Buffer|Uint8Array|null, pub_key: Buffer|Uint8Array|null, keyagg_cache: Ref_wally_musig_keyagg_cache, msg32: Buffer|Uint8Array|null, extra_input32: Buffer|Uint8Array|null): [secnonce_out: Ref_wally_musig_secnonce, pubnonce_out: Ref_wally_musig_pubnonce];
export function musig_nonce_process(aggnonce: Ref_wally_musig_aggnonce, msg32: Buffer|Uint8Array|null, cache: Ref_wally_musig_keyagg_cache, adaptor: Buffer|Uint8Array|null): Ref_wally_musig_session;
export function musig_partial_sig_agg(partial_sigs: Buffer|Uint8Array|null, n_sigs: number, session: Ref_wally_musig_session): Buffer;
export function musig_partial_sig_free(sig: Ref_wally_musig_partial_sig): void;
export function musig_partial_sig_parse(bytes: Buffer|Uint8Array|null): Ref_wally_musig_partial_sig;
export function musig_partial_sig_serialize(sig: Ref_wally_musig_partial_sig): Buffer;
export function musig_partial_sig_verify(sig: Ref_wally_musig_partial_sig, pubnonce: Ref_wally_musig_pubnonce, pub_key: Buffer|Uint8Array|null, cache: Ref_wally_musig_keyagg_cache, session: Ref_wally_musig_session): void;
export function musig_partial_sign(secnonce: Ref_wally_musig_secnonce, seckey: Buffer|Uint8Array|null, cache: Ref_wally_musig_keyagg_cache, session: Ref_wally_musig_session): Ref_wally_musig_partial_sig;
export function musig_pubkey_agg(pub_keys: Buffer|Uint8Array|null): [agg_pk_out: Buffer, cache_out: Ref_wally_musig_keyagg_cache];
export function musig_pubkey_ec_tweak_add(cache: Ref_wally_musig_keyagg_cache, tweak: Buffer|Uint8Array|null): Buffer;
export function musig_pubkey_get(cache: Ref_wally_musig_keyagg_cache): Buffer;
export function musig_pubkey_to_xpub(agg_pk: Buffer|Uint8Array|null, version: number): Ref_ext_key;
export function musig_pubkey_xonly_tweak_add(cache: Ref_wally_musig_keyagg_cache, tweak: Buffer|Uint8Array|null): Buffer;
export function musig_pubkeys_agg_then_derive(pub_keys: Buffer|Uint8Array|null, version: number, child_num: number): [pub_key_out: Buffer, child_out: Ref_ext_key];
export function musig_pubkeys_derive_then_agg(xpubs: Buffer|Uint8Array|null, child_num: number): [agg_pk_out: Buffer, cache_out: Ref_wally_musig_keyagg_cache];
export function musig_pubnonce_free(nonce: Ref_wally_musig_pubnonce): void;
export function musig_pubnonce_parse(bytes: Buffer|Uint8Array|null): Ref_wally_musig_pubnonce;
export function musig_pubnonce_serialize(nonce: Ref_wally_musig_pubnonce): Buffer;
export function musig_secnonce_free(nonce: Ref_wally_musig_secnonce): void;
export function musig_session_free(session: Ref_wally_musig_session): void;
export function musig_session_parse(bytes: Buffer|Uint8Array|null): Ref_wally_musig_session;
export function musig_session_serialize(session: Ref_wally_musig_session): Buffer;
...
export function psbt_clear_output_sp_v0_info(psbt: Ref_wally_psbt, index: number): void;
export function psbt_clear_output_sp_v0_label(psbt: Ref_wally_psbt, index: number): void;
...
export function psbt_get_input_sp_dleq_proof_len(psbt: Ref_wally_psbt, index: number, subindex: number): number;
...
export function psbt_get_output_sp_v0_info_len(psbt: Ref_wally_psbt, index: number): number;
export function psbt_get_output_sp_v0_label_len(psbt: Ref_wally_psbt, index: number): number;
...
export function psbt_input_set_sp_dleq_proof(input: Ref_wally_psbt_input, scan_key: Buffer|Uint8Array|null, proof: Buffer|Uint8Array|null): void;
export function psbt_input_set_sp_ecdh_share(input: Ref_wally_psbt_input, scan_key: Buffer|Uint8Array|null, share: Buffer|Uint8Array|null): void;
...
export function psbt_set_global_sp_dleq_proof(psbt: Ref_wally_psbt, scan_key: Buffer|Uint8Array|null, proof: Buffer|Uint8Array|null): void;
export function psbt_set_global_sp_ecdh_share(psbt: Ref_wally_psbt, scan_key: Buffer|Uint8Array|null, share: Buffer|Uint8Array|null): void;
...
export function psbt_set_output_sp_v0_info(psbt: Ref_wally_psbt, index: number, bytes: Buffer|Uint8Array|null): void;
export function psbt_set_output_sp_v0_label(psbt: Ref_wally_psbt, index: number, bytes: Buffer|Uint8Array|null): void;
...
export function psbt_get_output_sp_v0_info(psbt: Ref_wally_psbt, index: number): Buffer;
export function psbt_get_output_sp_v0_label(psbt: Ref_wally_psbt, index: number): Buffer;
