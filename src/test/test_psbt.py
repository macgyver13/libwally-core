...
class PSBTTests(unittest.TestCase):
    ...
    def test_bip375_vectors(self):
        ...
        self.assertEqual(counts['status'], 11)
        self.assertEqual(counts['eligibility'], 1)
        self.assertEqual(counts['derivation'], 3)
    ...
    def bip375_refusal(self, psbt, case):
        ...
        private keys, then a signing policy wally does not impose.
        """
        ...
        # A status of COMPLETE says the shares agree with each other, not that
        # the outputs were derived from them correctly.
