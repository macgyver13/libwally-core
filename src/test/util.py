...
for f in (
    ...
    ('wally_psbt_input_set_sp_dleq_proof', c_int, [POINTER(wally_psbt_input), c_void_p, c_size_t, c_void_p, c_size_t]),
    ...
    ('wally_psbt_set_global_sp_dleq_proof', c_int, [POINTER(wally_psbt), c_void_p, c_size_t, c_void_p, c_size_t]),
    ('wally_psbt_set_global_sp_ecdh_share', c_int, [POINTER(wally_psbt), c_void_p, c_size_t, c_void_p, c_size_t]),
