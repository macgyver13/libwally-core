...
for f in (
    ...
    ('wally_psbt_sp_musig_round1', c_int, [POINTER(wally_psbt), POINTER(wally_sp_musig_input), c_size_t, c_void_p, c_size_t, c_void_p, c_size_t, c_uint32, POINTER(c_void_p), c_void_p, c_size_t, c_size_t_p]),
    ('wally_psbt_sp_musig_round2', c_int, [POINTER(wally_psbt), POINTER(wally_sp_musig_input), c_size_t, c_void_p, c_size_t, POINTER(c_void_p), c_void_p, c_size_t, c_uint32]),
